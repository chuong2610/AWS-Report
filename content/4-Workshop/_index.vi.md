...
2. [Yêu cầu chuẩn bị](4.2-Prerequiste/)
3. [Thiết lập AWS Bedrock](4.3-Setup-Bedrock/)
4. [Triển khai Backend API](4.4-Deploy-Backend/)
5. [Triển khai Frontend](4.5-Deploy-Frontend/)
6. [Kiểm thử AI Agent](4.6-Testing/)
